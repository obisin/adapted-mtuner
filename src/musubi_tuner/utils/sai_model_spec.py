...
from musubi_tuner.dataset.image_video_dataset import (
    ...
    ARCHITECTURE_FLUX_DEV,
    ARCHITECTURE_FLUX_DEV_FULL,
...
IMPL_FLUX_DEV = "https://github.com/black-forest-labs/flux"
...
def build_metadata(
    ...
    elif architecture == ARCHITECTURE_FLUX_DEV:
        arch = ARCH_FLUX_DEV
        impl = IMPL_FLUX_DEV
    elif architecture == ARCHITECTURE_FLUX_DEV_FULL:
        arch = ARCH_FLUX_DEV
        impl = IMPL_FLUX_DEV
